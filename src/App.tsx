...
function App() {
    ...
    useEffect(() => {
        ...
        updateCountDowns()
        const interval = setInterval(updateCountDowns, 6000)
            ...
            <div className={'w-full bg-black text-white h-screen font-bold flex flex-col max-w-xl'}>
                ...
                <div className={'px-4 z-10'}>
                    ...
                    <div className={'flex items-center space-x-2 pt-4'}>
                        ...
                        <div>
                            <p className={'text-sm'}>David Gri</p>
                        </div>
                    </div>
                ...
                <div className={'flex-grow mt-4 bg-[#f3ba2f] rounded-t-[48px] relative top-glow z-0'}>
                    <div className={'absolute h-full top-[2px] left-0 right-0 bottom-0 bg-[#1d2025] rounded-t-[46px]'}>
                        ...
                        <div className={'px-4 mt-3 mb-1 flex justify-center'}>
                        ...
                        <div className={'px-4 mb-14 flex justify-center'}>
                            <div
